...
public class CodeGenerator {
    ...
    public void main1() {
        ...
        pc.setModuleName("eduorder"); //模块名（指定生成代码要放入的包）（com.wuze.eduorder）
        ...
        strategy.setInclude("t_order","t_pay_log");//一般只需改动这里的表名！！！
        strategy.setNaming(NamingStrategy.underline_to_camel);//数据库表映射到实体的命名策略
        strategy.setTablePrefix("t" + "_"); //生成实体时去掉表前缀（去掉 t 和 _ ）
