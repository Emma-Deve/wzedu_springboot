package com.wuze.aclservice.service;
...
public interface PermissionService extends IService<Permission> {
    ...
    //递归删除菜单 (wz)
    void removeChildMenuById(String id);
    ...
    //获取全部菜单
    List<Permission> queryAllMenuInfo();
    ...
    //给角色分配权限
    void saveRolePermissionRealtionShipByWz(String roleId, String[] permissionId);
}
